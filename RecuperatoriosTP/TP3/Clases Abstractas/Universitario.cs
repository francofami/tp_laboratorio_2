...
namespace EntidadesAbstractas
{
    public abstract class Universitario : Persona
    {
        ...
        /// </summary>
        /// <param name="legajo">El numero de legajo de Universitario</param>
        /// <param name="nombre">El nombre de Universitario</param>
        /// <param name="apellido">El apellido de Universitario</param>
        /// <param name="dni">El DNI de Universitario</param>
        /// <param name="nacionalidad">La nacionalidad de Universitario</param>
